...
let
  ...
  # Function to create a NixOS configuration for the specified system
  # and user. It includes the base modules, chaotic modules, and home-manager
...
in
{
  ...
  devShells.${system} = import ./dev/default.nix { pkgs = pkgs; };
}
